	...
	public class ManageFulfillmentOrders {
...
//	public static String url = "https://alaska.qa.grav.cm/";
	...
	public static FileWriter bwrite = null;
		...
		public ManageFulfillmentOrders() {	
		}
		...
		public static void main(String args[]) throws InterruptedException {
                        ...
                        try {
                          ...
                          bwrite = new FileWriter("ManageFulfillmentOrders.log",true);
                        }
                        catch(IOException i) {
                                i.printStackTrace();
                        }
...
//		  for (int myLoop=1; myLoop<4000000; myLoop++) {
			...
			ManageFulfillmentOrders addAmazonVDCRequestOrderApproval = new ManageFulfillmentOrders();
...
//			Thread.sleep(6000);
		 ...
		 for (int innerLoop=1; innerLoop<900000000; innerLoop++) {
			...
			System.out.println("Clicking on FULFILLMENT tab");
//			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//			element = driver.findElement(By.xpath("/html/body/div/div[1]/div/header/nav/div/div[2]/ul/li[6]/a/i[2]"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("/html/body/div/div[1]/div/header/nav/div/div[2]/ul/li[6]/a/i[2]")));
			element.click();
//			Thread.sleep(3000);


			System.out.println("Clicking Review All Orders");
//			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//			element = driver.findElement(By.xpath("/html/body/div/div[1]/div/header/nav/div/div[2]/ul/li[6]/ul/li[7]/a"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("/html/body/div/div[1]/div/header/nav/div/div[2]/ul/li[6]/ul/li[7]/a")));
...
//                        System.out.println("Start time is: "+strDate);
			...
			element.click();
                        ...
                        while(!driver.getPageSource().contains("All amounts shown in"));
                        {
                                ;
                        }
...
//                        System.out.println("End time is: "+endDate);
                        ...
                        //System.out.println("Response Time for Review All Orders to Complete - "+totalTime);
				...
				bwrite.write(cookie.getValue()+","+"ManageFulfillmentOrders,"+innerLoop+","+strDate+","+endDate+","+now1.getTime()+","+now2.getTime());
                                bwrite.write(System.lineSeparator());
                                //bwrite.write("Response Time for Review All Orders Page to load- "+totalTime);
                                bwrite.close();
                        } catch(IOException e) {
