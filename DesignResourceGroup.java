// package com.gravitant;
	...
	public class DesignResourceGroup {
	...
	protected static boolean isTextPresent(String text){
		...
		public static void main(String args[]) throws InterruptedException {
			...
			try {
			  ...
			  bwrite = new FileWriter("DesignResourceGroup.log",true);
			}
			catch(IOException i) {
				i.printStackTrace();
			}
...
//			  bwrite.write("Test Start Time - "+testStartDateTime);
			...
			DesignResourceGroup addAmazonVDCRequestOrderApproval = new DesignResourceGroup();
...
// OLD FOR LOOP STATEMENT HERE



                  for (int myLoop=1; myLoop<900000000; myLoop++) {
...
//                        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
 //                       element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/div/form/div[1]/a/label"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/div/form/div[1]/a/label")));
                        element.click();
                        //Thread.sleep(9000);
                        Thread.sleep(5000);
...
//			Select select = new Select(driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[3]/div[2]/div[1]/table/tbody/tr/td[1]/div/table/tbody/tr[1]/td/table/tbody/tr/td[2]/div/select")));
			Select select = new Select((new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[3]/div[2]/div[1]/table/tbody/tr/td[1]/div/table/tbody/tr[1]/td/table/tbody/tr/td[2]/div/select"))));
...
//			select = new Select(driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[3]/div[2]/div[1]/table/tbody/tr/td[1]/div/table/tbody/tr[2]/td/table/tbody/tr/td[2]/div/select")));
			select = new Select((new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[3]/div[2]/div[1]/table/tbody/tr/td[1]/div/table/tbody/tr[2]/td/table/tbody/tr/td[2]/div/select"))));
		...
		//	select = new Select(driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[3]/div[2]/div[1]/table/tbody/tr/td[1]/div/table/tbody/tr[3]/td/table/tbody/tr/td[2]/div/select")));
			select = new Select((new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[3]/div[2]/div[1]/table/tbody/tr/td[1]/div/table/tbody/tr[3]/td/table/tbody/tr/td[2]/div/select"))));
			select.selectByIndex(1);
			Thread.sleep(3000);
			...
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//			element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[3]/div[2]/div[1]/table/tbody/tr/td[1]/div/table/tbody/tr[4]/td/table/tbody/tr/td[2]/div/input"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[3]/div[2]/div[1]/table/tbody/tr/td[1]/div/table/tbody/tr[4]/td/table/tbody/tr/td[2]/div/input")));
			//element.sendKeys("VDC"+myLoop);
	             DateFormat dateFormat = new SimpleDateFormat("ddMMyyyyHHmmss");
       	             Date date = new Date();
                     String uniqueVDCName = dateFormat.format(date);
		     String extraString = args[3].toString();
			element.sendKeys(extraString+uniqueVDCName);
			//Thread.sleep(2000);
			
			
			System.out.println("Specify VDC Namespace");
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		//	element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[3]/div[2]/div[1]/table/tbody/tr/td[1]/div/table/tbody/tr[5]/td/table/tbody/tr/td[2]/div/input"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[3]/div[2]/div[1]/table/tbody/tr/td[1]/div/table/tbody/tr[5]/td/table/tbody/tr/td[2]/div/input")));
...
//			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//			element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[5]/div/a[2]/label"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[5]/div/a[2]/label")));
			element.click();
			//Thread.sleep(6000);
		//	Thread.sleep(2000);
                      ...
                      //  driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//                        element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[6]/div/div[2]/div/div/table/tbody/tr/td/div/table/tbody/tr/td[1]/input"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[6]/div/div[2]/div/div/table/tbody/tr/td/div/table/tbody/tr/td[1]/input")));
                        element.click();
                        //Thread.sleep(6000);
                        //Thread.sleep(1000);
                   ...
                   //     driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//                        element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[6]/div/div[2]/div/div/div/table/tbody/tr/td[2]/div/input"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div/div[2]/table/tbody/tr[2]/td/div/div/div[4]/div[6]/div/div[2]/div/div/div/table/tbody/tr/td[2]/div/input")));
...
//			element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[5]/div/div[2]/div/a[2]/label"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[5]/div/div[2]/div/a[2]/label")));
			element.submit();
			element.click();
			//Thread.sleep(3000);
			//Thread.sleep(2000);
...
//			element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[5]/div/div/a[3]/label"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div[1]/div[2]/table/tbody/tr[2]/td/div/div/div[5]/div/div/a[3]/label")));
			element.click();
			//Thread.sleep(32000);
			//Thread.sleep(14000);
...
//                        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
 //                       element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div/div[1]/table/tbody/tr/td[2]/div/div[2]/table/tbody/tr/td[5]/div/table/tbody/tr/td[1]/div/div[1]/a/span"));
			element = (new WebDriverWait(driver, 14)).until(ExpectedConditions
...
//                        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//                        element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div/div[1]/table/tbody/tr/td[2]/div/div[2]/table/tbody/tr/td[5]/div/table/tbody/tr/td[1]/div/div[2]/div/a/img"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div/div[1]/table/tbody/tr/td[2]/div/div[2]/table/tbody/tr/td[5]/div/table/tbody/tr/td[1]/div/div[2]/div/a/img")));
                        element.click();
                        //Thread.sleep(10000);
 //                       Thread.sleep(1000);
...
//                        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
 //                       element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div/div[1]/table/tbody/tr/td[2]/div/div[2]/table/tbody/tr/td[5]/div/table/tbody/tr/td[1]/div/div[3]/div[1]/a/span"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[1]/div/div[1]/table/tbody/tr/td[2]/div/div[2]/table/tbody/tr/td[5]/div/table/tbody/tr/td[1]/div/div[3]/div[1]/a/span")));
                        element.click();
                        //Thread.sleep(15000);
                        //Thread.sleep(4000);
...
//                        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
 //                       select = new Select(driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[10]/div/div/div[2]/table/tbody/tr[2]/td/div/div/div[2]/table/tbody/tr[4]/td[2]/div/table/tbody/tr/td/div/select")));
			select = new Select((new WebDriverWait(driver, 10)).until(ExpectedConditions
                        ...
                        System.out.println("Specify VDC Name");
//                        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
 //                       element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[10]/div/div/div[2]/table/tbody/tr[2]/td/div/div/div[2]/table/tbody/tr[5]/td[2]/div/table/tbody/tr/td[1]/div/input"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
...
//                        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
 //                       element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[10]/div/div/div[2]/table/tbody/tr[2]/td/div/div/div[2]/table/tbody/tr[6]/td[2]/div/table/tbody/tr/td[1]/div/input"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
...
//                       driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
 //                      element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[10]/div/div/div[2]/table/tbody/tr[2]/td/div/div/div[3]/table/tbody/tr/td[2]/a/label"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
...
//			  	bwrite.write("Current Time - "+currentDateTime);
                                bwrite.write(cookie.getValue()+","+"DesignResourceGroup,"+myLoop+","+strDate+","+endDate+","+now1.getTime()+","+now2.getTime());
			  	bwrite.write(System.lineSeparator());
...
/*
				...
				element = (new WebDriverWait(driver, 12)).until(ExpectedConditions
...
//                                element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/form[28]/div/div/div[2]/table/tbody/tr[2]/td/div/div/div[5]/div[2]/a/label"));
	...
	//			element = driver.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td/div/div/form[2]/div/table/tbody/tr/td[2]/div/div/div/table/tbody/tr[5]/td/a"));
				element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
                                .visibilityOfElementLocated(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td/div/div/form[2]/div/table/tbody/tr/td[2]/div/div/div/table/tbody/tr[5]/td/a")));
				element.click();
//				Thread.sleep(3000);
