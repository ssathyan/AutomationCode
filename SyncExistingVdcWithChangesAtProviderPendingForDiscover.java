	...
	public class SyncExistingVdcWithChangesAtProviderPendingForDiscover {
	...
	public static WebElement element;
		...
		public SyncExistingVdcWithChangesAtProviderPendingForDiscover() {	
		}

	/*
		public void performSyncAfterFirstSync() throws InterruptedException {
	...
	*/
		...
		public static void main(String args[]) throws InterruptedException {
                        ...
                        try {
                          ...
                          bwrite = new FileWriter("SyncExistingVdcWithChangesAtProviderPendingForDiscover.log",true);
                        }
                        catch(IOException i) {
                                i.printStackTrace();
                        }
...
//                          bwrite.write("Test Start Time - "+testStartDateTime);
			...
			SyncExistingVdcWithChangesAtProviderPendingForDiscover syncOperation = new SyncExistingVdcWithChangesAtProviderPendingForDiscover();
...
// PREVIOUS FOR LOOP
			...
			Thread.sleep(3000);
			/*
			System.out.println("Enter search VDC name");
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			element = driver.findElement(By.xpath("html/body/div[1]/section/div[3]/table/tbody/tr/td[1]/div/div/div/form/table[2]/tbody/tr/td[3]/input"));
			...
			*/
			...
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			element = driver
				.findElement(By.xpath("html/body/div[1]/section/div[3]/table/tbody/tr/td[1]/div/div/div/form/table[2]/tbody/tr/td[4]/a/img"));
			element.click();
			Thread.sleep(3000);
			...
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			element = driver
				.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/div/form/table[2]/tbody/tr/td[3]/input"));
			...
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			element = driver
				.findElement(By.xpath("/html/body/div/section/div[3]/table/tbody/tr/td[1]/div/div/div/form/table[2]/tbody/tr/td[4]/a/img"));
			element.click();
			Thread.sleep(6000);
			...
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			element = driver
				.findElement(By.xpath("html/body/div[1]/section/div[3]/table/tbody/tr/td[1]/div/div/div/form/div[3]/div[1]/table/tbody/tr/td[6]/div/div[2]/div[4]/a/span"));
			element.click();
			Thread.sleep(15000);
...
//			}
				...
				element.click();
                        ...
                        try {
                                ...
                                bwrite.write(cookie.getValue()+","+"SyncExistingVdcWithChangesAtProviderPendingForDiscover,"+myLoop+","+strDate+","+endDate+","+now1.getTime()+","+now2.getTime());
                                bwrite.write(System.lineSeparator());
                                bwrite.close();
                        } catch(IOException e) {
...
/*
				...
				System.out.println("Click on Sign_out Tab");
				driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//a[@id='User_Profile_Menu']")));
				element.click();
				Thread.sleep(14000);


				System.out.println("Click on Sign_out");
				driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//a[@id='Sign_Out_Menu']")));
				element.click();
				Thread.sleep(9000);
