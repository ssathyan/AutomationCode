	...
	public static FileWriter bwrite = null;
		...
		public static void main(String args[]) throws InterruptedException {
                        ...
                        try {
                          ...
                          bwrite = new FileWriter("DashboardReports.log",true);
                        }
                        catch(IOException i) {
                                i.printStackTrace();
                        }
...
//		  for (int myLoop=1; myLoop<4000000; myLoop++) {
			...
			DashboardReports addAmazonVDCRequestOrderApproval = new DashboardReports();
...
//			Thread.sleep(3000);
			...
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
//			element = driver.findElement(By.xpath("/html/body/div/div[1]/div/header/nav/div/div[2]/ul/li[3]/ul/li[19]/a"));
			element = (new WebDriverWait(driver, 10)).until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("/html/body/div/div[1]/div/header/nav/div/div[2]/ul/li[3]/ul/li[19]/a")));
...
//                        System.out.println("Start time is: "+strDate);
			...
			element.click();
                        ...
                        //while(!driver.getPageSource().contains("Cloud Command and Control - Monitoring"));
                        while(!driver.getPageSource().contains("pups"));
                        {
                                ;
                        }
...
//                        System.out.println("Response Time for Reports page to load- "+totalTime);
 ...
 //                             bwrite.write("Current Time - "+currentDateTime);
				bwrite.write(cookie.getValue()+","+"DashboardReports,"+innerLoop+","+strDate+","+endDate+","+now1.getTime()+","+now2.getTime());
                                bwrite.write(System.lineSeparator());
 //                             bwrite.write("Response Time for Reports Page to load- "+totalTime);
                                bwrite.close();
                        } catch(IOException e) {
