// package com.gravitant;
	...
	public class DoingVariousActionsInVdc {
...
//	public static String url = "https://alaska.qa.grav.cm/";
	...
	protected static boolean isTextPresent(String text){
		...
		public DoingVariousActionsInVdc() {	
		}
		...
		public static void main(String args[]) throws InterruptedException {
			...
			try {
			  ...
			  bwrite = new FileWriter("DoingVariousActionsInVdc.log",true);
			}
			catch(IOException i) {
				i.printStackTrace();
			}
...
//			  bwrite.write("Test Start Time - "+testStartDateTime);
		  ...
		  for (int myLoop=1; myLoop<4000000; myLoop++) {
			...
			DoingVariousActionsInVdc addAmazonVDCRequestOrderApproval = new DoingVariousActionsInVdc();
...
// PREVIOUS FOR LOOP STATEMENT HERE
...
//			  	bwrite.write("Current Time - "+currentDateTime);
                                bwrite.write(cookie.getValue()+","+"DoingVariousActionsInVdc,"+myLoop+","+strDate+","+endDate+","+now1.getTime()+","+now2.getTime());
			  	bwrite.write(System.lineSeparator());
